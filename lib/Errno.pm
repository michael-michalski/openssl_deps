...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAESOCKTNOSUPPORT WSAEALREADY WSAECANCELLED WSAEAFNOSUPPORT
	WSAECONNRESET WSAENETDOWN WSAESTALE WSAENETRESET WSAEINVALIDPROCTABLE
	WSAEACCES WSAEDISCON WSAEDQUOT WSAEADDRNOTAVAIL WSAETOOMANYREFS
	WSAEINTR WSAEPROTOTYPE WSAENOPROTOOPT WSAEUSERS WSAEREFUSED
	WSAEWOULDBLOCK WSAECONNREFUSED WSAEINVALIDPROVIDER WSAENETUNREACH
	WSAEOPNOTSUPP WSAEPROCLIM WSAECONNABORTED WSAENOTEMPTY WSAESHUTDOWN
	WSAEINPROGRESS WSAEINVAL WSAEPFNOSUPPORT WSAENOTSOCK
	WSAEPROVIDERFAILEDINIT WSAEBADF WSAEREMOTE WSAEISCONN WSAENAMETOOLONG
	WSAEFAULT WSAEADDRINUSE WSAEDESTADDRREQ WSAENOTCONN WSAENOMORE
	WSAEHOSTDOWN WSAEMFILE WSAEHOSTUNREACH WSAEMSGSIZE WSAENOBUFS WSAELOOP
	WSAETIMEDOUT WSAEPROTONOSUPPORT
    )],
);
